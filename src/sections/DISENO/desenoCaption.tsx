interface DisenoCaptionProps {
  texto1: string;
  texto2: string;
  className?: string;
}

export default function DisenoCaption({
  texto1,
  texto2,
  className = "",
}: DisenoCaptionProps) {
  return (
    <div
      className={`process-section__caption-wrapper ${className} dsncapt `}
      style={{ textAlign: "left", marginBlock: "1vh" }}
    >
      <blockquote className="process-section__caption process-section__caption--top dsctt">
      ...
      <blockquote className="process-section__caption process-section__caption--bottom text-[#aeaeb0] dsctt">
